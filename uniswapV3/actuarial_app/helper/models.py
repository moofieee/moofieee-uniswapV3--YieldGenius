...
from pydantic import BaseModel, HttpUrl
>>>>>>> 25bbaf56a11039b0726734fbb292f0c084475264:actuarial_app/helper/models.py
...
<<<<<<< HEAD:actuarial_app/models.py
    psm_fee_in: Optional[Any]
    psm_fee_out: Optional[Any]
=======
...
class CollateralHistory(BaseModel):
    date: datetime
    dai_cap: Decimal
    temp_dai_cap: Decimal
    dai_total: Decimal
    fee: Decimal
    psm_fee_in: Optional[Decimal]
    psm_fee_out: Optional[Decimal]
    fees_owed: Decimal
    liquidation_profit: Optional[Decimal]
    price: Decimal
    name: str
