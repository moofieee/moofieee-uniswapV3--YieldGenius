...
from actuarial_app import models #import models
=======
import pandas as pd
...
from actuarial_app.integration.urls import defilamma as url
...
if __name__ == "__main__":
    print("DefiLamma Data Pull")
    data = list(defilamma_raw())
    # defilamma_pipeline()s
=======
